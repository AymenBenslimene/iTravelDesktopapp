...
create_window_hotels (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed4), treeviewmembers, 232, 144);
  gtk_widget_set_size_request (treeviewmembers, 528, 200);
  ...
  gtk_fixed_put (GTK_FIXED (fixed4), label17, 912, 104);
  gtk_widget_set_size_request (label17, 144, 47);

  label58 = gtk_label_new (_("name of hotel"));
  gtk_widget_show (label58);
  gtk_fixed_put (GTK_FIXED (fixed4), label58, 792, 176);
  gtk_widget_set_size_request (label58, 104, 33);

  entry164 = gtk_entry_new ();
  gtk_widget_show (entry164);
  gtk_fixed_put (GTK_FIXED (fixed4), entry164, 928, 176);
  gtk_widget_set_size_request (entry164, 160, 27);
  ...
  delet_hotel = gtk_button_new_with_mnemonic (_("deleted"));
  gtk_widget_show (delet_hotel);
  gtk_fixed_put (GTK_FIXED (fixed4), delet_hotel, 968, 272);
  gtk_widget_set_size_request (delet_hotel, 66, 29);
  ...
  g_signal_connect ((gpointer) saved_hotels_to_treeview_add, "clicked",
                    ...
                    NULL);
  g_signal_connect ((gpointer) delet_hotel, "clicked",
                    G_CALLBACK (on_delet_hotel_clicked),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (window_hotels, label58, "label58");
  GLADE_HOOKUP_OBJECT (window_hotels, entry164, "entry164");
  ...
  GLADE_HOOKUP_OBJECT (window_hotels, delet_hotel, "delet_hotel");
...
create_window_offre_of_the_days (void)
{
  ...
  gtk_widget_set_size_request (treeview_offre_of_the_day, 568, 208);
  ...
  gtk_fixed_put (GTK_FIXED (fixed7), entry165, 912, 184);
  gtk_widget_set_size_request (entry165, 184, 40);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry165), 8226);

  label36 = gtk_label_new (_("offre name"));
  gtk_widget_show (label36);
  gtk_fixed_put (GTK_FIXED (fixed7), label36, 912, 112);
  gtk_widget_set_size_request (label36, 192, 41);

  ya_delet_offre = gtk_button_new_with_mnemonic (_("delet"));
  gtk_widget_show (ya_delet_offre);
  gtk_fixed_put (GTK_FIXED (fixed7), ya_delet_offre, 968, 264);
  gtk_widget_set_size_request (ya_delet_offre, 80, 37);
  ...
  g_signal_connect ((gpointer) saved_to_text_offre, "clicked",
                    ...
                    NULL);
  g_signal_connect ((gpointer) ya_delet_offre, "clicked",
                    G_CALLBACK (on_ya_delet_offre_clicked),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (window_offre_of_the_days, entry165, "entry165");
  GLADE_HOOKUP_OBJECT (window_offre_of_the_days, label36, "label36");
  GLADE_HOOKUP_OBJECT (window_offre_of_the_days, ya_delet_offre, "ya_delet_offre");
...
create_window_name_of_leasing (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed10), treeview2, 208, 128);
  gtk_widget_set_size_request (treeview2, 640, 208);
  ...
  label53 = gtk_label_new (_("name of the car"));
  ...
  gtk_fixed_put (GTK_FIXED (fixed10), entry166, 920, 168);
  gtk_widget_set_size_request (entry166, 208, 48);
  gtk_entry_set_invisible_char (GTK_ENTRY (entry166), 8226);

  label54 = gtk_label_new (_(" leasing"));
  gtk_widget_show (label54);
  gtk_fixed_put (GTK_FIXED (fixed10), label54, 344, 88);
  gtk_widget_set_size_request (label54, 312, 48);

  ya_delet_car = gtk_button_new_with_mnemonic (_("delet"));
  gtk_widget_show (ya_delet_car);
  gtk_fixed_put (GTK_FIXED (fixed10), ya_delet_car, 968, 248);
  gtk_widget_set_size_request (ya_delet_car, 120, 32);
  ...
  g_signal_connect ((gpointer) saved3_to_users3, "clicked",
                    ...
                    NULL);
  g_signal_connect ((gpointer) ya_delet_car, "clicked",
                    G_CALLBACK (on_ya_delet_car_clicked),
                    NULL);
  ...
  GLADE_HOOKUP_OBJECT (window_name_of_leasing, entry166, "entry166");
  GLADE_HOOKUP_OBJECT (window_name_of_leasing, label54, "label54");
  GLADE_HOOKUP_OBJECT (window_name_of_leasing, ya_delet_car, "ya_delet_car");

...
create_mywindow (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), entryNom, 168, 72);
  ...
  gtk_fixed_put (GTK_FIXED (fixed1), labelnom, 40, 72);
  gtk_widget_set_size_request (labelnom, 104, 25);

  buttonHello = gtk_button_new_with_mnemonic (_("Hello"));
  gtk_widget_show (buttonHello);
  gtk_fixed_put (GTK_FIXED (fixed1), buttonHello, 128, 144);
  gtk_widget_set_size_request (buttonHello, 68, 29);

  labelHello = gtk_label_new (_("Hello"));
  gtk_widget_show (labelHello);
  gtk_fixed_put (GTK_FIXED (fixed1), labelHello, 128, 216);
